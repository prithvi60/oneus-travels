...
import { PrimaryButtonWelcome } from "./Button";

export const WelcomeSection = () => {
  return (
    <section className="w-full h-auto px-[24px] py-7 max-w-[1200px] mx-auto space-y-4">
      <h1 className="w-full text-[32px] font-bold font-WorkSans md:text-[40px] lg:text-[42px] leading-tight text-secondary pt-5">
      ...
      <p className="text-base font-WorkSans font-normal">
      ...
      <p className="text-base font-WorkSans font-light">
