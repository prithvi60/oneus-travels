    ...
    >
      ...
      <div className="space-y-7">
        <p className="w-full h-full text-base font-normal font-Poppins">
          Elevate your corporate meetings and events with OneUs Travels' specialized event management team,  <Link href="/about/meet-the-team" className="underline">OneT</Link>. Our experienced event planners create meticulously organized and reschedulable meetings and events that not only enhance attendee experiences but also deliver strategic advantages for your business—all while optimizing your travel expenditure.
        </p>
