...
export const PrimaryButton = ({ text, roleType }) => {
  return (
    ...
    >
      <h2 className="text-xs font-semibold tracking-wider uppercase sm:text-sm font-lato text-secondary group-hover:text-primary">{text}</h2>
...
export const SecondaryButton = ({ text, roleType }) => {
  return (
    ...
    >
      <h2 className="text-sm font-semibold tracking-wider uppercase font-lato text-secondary group-hover:text-primary">{text}</h2>
      <FaAngleRight size={16} className="font-semibold text-secondary group-hover:text-primary" />
    </button>
  );
};
