...
export const GlobalTeam = () => {
  ...
  return (
    <section
      className="w-full h-auto px-[24px] py-7 space-y-6 md:space-y-10 max-w-[1200px] mx-auto"
      ref={globalRef}
    >
      ...
      <div className="space-y-7">
        <p className="text-base font-lato w-full h-full">
      ...
      />
      <div className="w-full h-full relative gap-2 lg:gap-0 flex flex-col-reverse lg:flex-row lg:justify-end lg:items-center">
