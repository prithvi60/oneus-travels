...
export const GlobalTeam = () => {
  ...
  return (
    <section
      ...
      ref={globalRef}
    >
      <h3 className="text-[32px] md:text-[40px] lg:text-[42px] tracking-normal font-DMSans text-secondary">
        Corporate Meetings & Events
      </h3>
      <div className="space-y-7">
        <p className="w-full h-full text-base font-normal font-WorkSans">
