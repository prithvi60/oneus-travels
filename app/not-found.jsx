...
export default function NotFound() {
  return (
    <section className="px-5 py-10 md:px-10 md:py-[35px] lg:px-[60px] lg:py-12 font-WorkSans bg-primary text-secondary space-y-6 mx-auto h-full w-full text-center">
